...
'Французский'))
question_list.append(Question('Самая большая по площади в мире','Россия','США','Австралия','Канада'))
question_list.append(Question('Год рождения А.С.Пушкина','1799','1756','1879','1999'))
question_list.append(Question('Кто президент России в 2021 году','Владимир Путин','Поль Бийя','Теодоро Обианг','Александр Лукашенко'))
question_list.append(Question('Дата выхода первого iPhone','2007', '2005','2008','2001'))
